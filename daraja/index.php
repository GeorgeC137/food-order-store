        ...
        <div class="media mt-3 pl-2">
            ...
            <form class="row g-3" action="./stk_initiate.php" method="POST">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" name="amount" maxlength="5" placeholder="Enter Amount">
                </div>
                <div class="col-12">
                  <label for="inputAddress2" class="form-label" >Phone Number</label>
                  <input type="text" class="form-control" name="phone"  maxlength="12" placeholder="Enter Phone Number">
                </div>
